...
var target_camera_speed = 60.0  # Final speed
var ramp_up_duration = 6.0  # Time to reach full speed
...
func _process(delta):
	...
	# Start ramp up once delay is done
...
func move_camera(delta):
	...
	# Parallax effect (slower layers move less)
